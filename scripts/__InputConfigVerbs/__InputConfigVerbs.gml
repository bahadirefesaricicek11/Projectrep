function __InputConfigVerbs()
{
    ...
    if (not INPUT_ON_SWITCH)
    {
        ...
        InputDefineVerb(INPUT_VERB.INVENTORY,  "inventory",  [vk_control,"C","E"],    [gp_face4]);
    ...
    else //Flip A/B over on Switch
    {
        ...
        InputDefineVerb(INPUT_VERB.DELETE,     "delete",     undefined,		[		   ]);
        InputDefineVerb(INPUT_VERB.INVENTORY,  "inventory",  undefined,		[gp_face3]);
        InputDefineVerb(INPUT_VERB.ACTION,     "action",     undefined,		[gp_face4]);
        InputDefineVerb(INPUT_VERB.PAUSE,      "pause",      undefined,		[gp_start]);
        InputDefineVerb(INPUT_VERB.FULLSCREEN, "fullscreen", undefined,		[gp_select]);
        InputDefineVerb(INPUT_VERB.L1,		   "l1",		 undefined,		[gp_shoulderl]);
        InputDefineVerb(INPUT_VERB.R1,		   "r1",		 undefined,		[gp_shoulderr]);
    }

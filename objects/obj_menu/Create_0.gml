...
instance_create_depth(0, 0, 10000, obj_scrolling_background);
...
if (is_ingame) {
    ds_menu_main = create_menu_page(
        ["menu.resume",    menu_element_type.script_runner, function() { instance_destroy(obj_scrolling_background); instance_destroy(); global.state = GAME_STATE.PLAYING;}],
